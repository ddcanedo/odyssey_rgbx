...
from models.finetune_builder import EncoderDecoder as segmodel
...
with Engine(custom_parser=parser) as engine:
    ...
    if config.optimizer == 'AdamW':
        optimizer = torch.optim.AdamW(model.parameters(), lr=base_lr, betas=(0.9, 0.999), weight_decay=config.weight_decay)
